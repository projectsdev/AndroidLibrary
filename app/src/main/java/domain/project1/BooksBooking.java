...
public class BooksBooking extends AppCompatActivity {
    ...
    public void onBackPressed() {
        startActivity(new Intent(this,controlActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
        finish();
                        ...
                        try {
                            ...
                            if(fetch == 0){
                                ...
                                while (keys.hasNext()) {
                                    ...
                                    adapter = new BookingBookAdapter(context, no_books,recyclerView,linearLayout,order_text ,progress,bookDetails
